...
Build a complete **Student Application Management System** where users can register students, validate their information, display applications dynamically, search/filter students, edit/delete records, and preserve the data using Local Storage.
...
# Task 12 — Local Storage

### Suggested Time: 15 Minutes

Student records should remain available after refreshing the page.
...
1. Read student data from Local Storage.
2. Restore the `students` array.
3. Display all saved student cards.
4. Update statistics.

Refreshing the browser should **not delete student data**.
