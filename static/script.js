...
studentForm.addEventListener("submit", function(event) {
    ...
    const course = document.querySelector("#courseSelector").value;
    ...
    const about = document.querySelector("#about-student").value;


    const photoInput = document.querySelector("#profile-pic");
